...
from CheckinWalkin2_ui import *
from DatabaseSystem import *

class CheckinWalkin(QMainWindow):
    def __init__(self,menu):
        QMainWindow.__init__(self, None)
        
        loader = QUiLoader()
        form = loader.load("UI/uiCheckinWalkin.ui", None)
    ...
    def reserve(self):
        if (len(self.tableWidget.selectedRanges())  >0):
            ...
            self.CheckinWalkin2 = CheckinWalkin2(self,selectedRoom,self.searchedItem)
            self.CheckinWalkin2.show()
            self.hide()
